...
.method public onGlobalLayout()V
    ...
    const-string v2, "ebpay_selectpay_scrollview"
    ...
    const-string v3, "ebpay_scrollview_root_child"
    ...
    const-string v4, "ebpay_confirm_layout_divideline"
