...
.method private d()V
    ...
    invoke-static {v1}, Lcom/baidu/bdgame/sdk/obf/lv;->f(Landroid/content/Context;)I
    ...
    invoke-static {v1}, Lcom/baidu/bdgame/sdk/obf/lv;->g(Landroid/content/Context;)I
    ...
    invoke-static {v0, v3}, Lcom/baidu/bdgame/sdk/obf/lv;->a(Landroid/content/Context;F)I
