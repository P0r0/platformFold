.class public Lcom/huanju/data/content/raw/video/d;
...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;III)V
    ...
    iput-object v0, p0, Lcom/huanju/data/content/raw/video/d;->a:Landroid/content/Context;

    const-string v0, ""

    iput-object v0, p0, Lcom/huanju/data/content/raw/video/d;->b:Ljava/lang/String;

    const/16 v0, 0xa

    iput v0, p0, Lcom/huanju/data/content/raw/video/d;->c:I

    const/4 v0, 0x1

    iput v0, p0, Lcom/huanju/data/content/raw/video/d;->d:I

    const/4 v0, 0x0

    iput v0, p0, Lcom/huanju/data/content/raw/video/d;->e:I
    ...
    iput-object p2, p0, Lcom/huanju/data/content/raw/video/d;->b:Ljava/lang/String;

    iput p3, p0, Lcom/huanju/data/content/raw/video/d;->c:I

    iput p4, p0, Lcom/huanju/data/content/raw/video/d;->d:I

    iput p5, p0, Lcom/huanju/data/content/raw/video/d;->e:I
...
.method public a(Lcom/huanju/data/content/raw/listener/IHjRequestItemListListener;)V
    ...
    iput-object p1, p0, Lcom/huanju/data/content/raw/video/d;->f:Lcom/huanju/data/content/raw/listener/IHjRequestItemListListener;
...
.method protected createNetTask()Lcom/huanju/data/net/AbstractNetTask;
    ...
    new-instance v0, Lcom/huanju/data/content/raw/video/a;

    iget-object v1, p0, Lcom/huanju/data/content/raw/video/d;->a:Landroid/content/Context;

    iget-object v2, p0, Lcom/huanju/data/content/raw/video/d;->b:Ljava/lang/String;

    iget v3, p0, Lcom/huanju/data/content/raw/video/d;->c:I

    iget v4, p0, Lcom/huanju/data/content/raw/video/d;->d:I

    iget v5, p0, Lcom/huanju/data/content/raw/video/d;->e:I

    invoke-direct/range {v0 .. v5}, Lcom/huanju/data/content/raw/video/a;-><init>(Landroid/content/Context;Ljava/lang/String;III)V
...
.method public onDataReceived(Lorg/apache/http/HttpResponse;)V
    ...
    iget-object v0, p0, Lcom/huanju/data/content/raw/video/d;->f:Lcom/huanju/data/content/raw/listener/IHjRequestItemListListener;

    if-eqz v0, :cond_1b

    iget-object v0, p0, Lcom/huanju/data/content/raw/video/d;->mResponseParser:Lcom/huanju/data/content/raw/b;
    ...
    :cond_1c
    iget-object v1, p0, Lcom/huanju/data/content/raw/video/d;->f:Lcom/huanju/data/content/raw/listener/IHjRequestItemListListener;
