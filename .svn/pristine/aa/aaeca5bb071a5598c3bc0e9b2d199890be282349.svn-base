.class public Lcom/baidu/bdgame/sdk/obf/be;
...
# static fields
.field private static final a:S = 0x10s
...
.method public static a(Landroid/content/Context;Ljava/lang/String;)Lcom/baidu/bdgame/sdk/obf/be;
    .registers 5

    .prologue
    .line 33
    new-instance v0, Lcom/baidu/bdgame/sdk/obf/be;
    ...
    invoke-direct {v0, p0, v1, v2}, Lcom/baidu/bdgame/sdk/obf/be;-><init>(Landroid/content/Context;Ljava/lang/String;Lcom/baidu/bdgame/sdk/obf/la;)V

    .line 34
    const/4 v1, 0x4

    invoke-virtual {v0, v1}, Lcom/baidu/bdgame/sdk/obf/be;->b(I)V

    .line 35
    const/16 v1, 0x10

    invoke-virtual {v0, v1}, Lcom/baidu/bdgame/sdk/obf/be;->a(S)V

    .line 36
    iput-object p1, v0, Lcom/baidu/bdgame/sdk/obf/be;->b:Ljava/lang/String;
...
.method protected a(Lcom/baidu/bdgame/sdk/obf/la;)Lorg/json/JSONObject;
    ...
    iget-object v2, p0, Lcom/baidu/bdgame/sdk/obf/be;->b:Ljava/lang/String;
...
.method protected a(Lcom/baidu/bdgame/sdk/obf/la;ILcom/baidu/bdgame/sdk/obf/ky;Lorg/json/JSONObject;)Z
    ...
    .line 62
    invoke-virtual {v1, v2}, Lcom/baidu/bdgame/sdk/obf/bd;->a(I)V
