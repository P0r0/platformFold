...
.method constructor <init>(Lcom/baidu/paysdk/ui/PwdSetAndConfirmActivity;)V
    ...
    iput-object p1, p0, Lcom/baidu/paysdk/ui/bz;->a:Lcom/baidu/paysdk/ui/PwdSetAndConfirmActivity;

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    const/4 v0, 0x0

    iput-boolean v0, p0, Lcom/baidu/paysdk/ui/bz;->b:Z
...
.method public onTextChanged(Ljava/lang/CharSequence;III)V
    ...
    iget-boolean v0, p0, Lcom/baidu/paysdk/ui/bz;->b:Z

    if-nez v0, :cond_16

    iget-object v0, p0, Lcom/baidu/paysdk/ui/bz;->a:Lcom/baidu/paysdk/ui/PwdSetAndConfirmActivity;

    const-string v1, "clickConfirmPwd"

    const-string v2, ""

    iget-object v3, p0, Lcom/baidu/paysdk/ui/bz;->a:Lcom/baidu/paysdk/ui/PwdSetAndConfirmActivity;
