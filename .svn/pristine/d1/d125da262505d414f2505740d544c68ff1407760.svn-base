...
.method public uri()Ljava/net/URI;
    ...
    invoke-static {v2, v3, v4, v5}, Lcom/squareup/okhttp/HttpUrl;->canonicalize(Ljava/lang/String;Ljava/lang/String;ZZ)Ljava/lang/String;

    move-result-object v1

    .line 336
    .local v1, "uriSafeUrl":Ljava/lang/String;
    new-instance v2, Ljava/net/URI;

    invoke-direct {v2, v1}, Ljava/net/URI;-><init>(Ljava/lang/String;)V
    :try_end_f
    .catch Ljava/net/URISyntaxException; {:try_start_0 .. :try_end_f} :catch_10

    return-object v2

    .line 337
    .end local v1    # "uriSafeUrl":Ljava/lang/String;
    :catch_10
    move-exception v0
