...
.method public constructor <init>(Lcom/baidu/android/pushservice/e/m;Landroid/content/Context;Ljava/lang/String;)V
    ...
    iput-object p3, p0, Lcom/baidu/android/pushservice/e/s;->e:Ljava/lang/String;
...
.method protected a(Ljava/util/HashMap;)V
    ...
    const-string v1, "gunbind"

    invoke-virtual {p1, v0, v1}, Ljava/util/HashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v0, "gid"

    iget-object v1, p0, Lcom/baidu/android/pushservice/e/s;->e:Ljava/lang/String;

    invoke-virtual {p1, v0, v1}, Ljava/util/HashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v0, "Gunbind"

    new-instance v1, Ljava/lang/StringBuilder;

    invoke-direct {v1}, Ljava/lang/StringBuilder;-><init>()V

    const-string v2, "Gunbind param -- "
