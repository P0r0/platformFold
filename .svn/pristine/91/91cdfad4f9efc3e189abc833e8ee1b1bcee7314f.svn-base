...
.method static constructor <clinit>()V
    ...
    sput v0, Lcom/baidu/android/pushservice/util/g;->a:I
...
.method public static a(Landroid/content/Context;Lorg/json/JSONObject;)Ljava/lang/String;
    ...
    invoke-virtual {v1, v2, v3}, Lorg/json/JSONObject;->put(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    :try_end_61
    .catch Lorg/json/JSONException; {:try_start_b .. :try_end_61} :catch_71
...
.method public static a(Landroid/content/Context;Z)Ljava/lang/String;
    ...
    invoke-static {p0}, Lcom/baidu/android/pushservice/util/g;->d(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-static {p0}, Lcom/baidu/android/pushservice/util/g;->b(Landroid/content/Context;)Z

    move-result v0

    if-eqz v0, :cond_29

    invoke-static {p0}, Lcom/baidu/android/pushservice/util/g;->a(Landroid/content/Context;)Ljava/lang/String;
    ...
    :cond_29
    invoke-static {}, Lcom/baidu/android/pushservice/util/g;->a()Ljava/lang/String;
    ...
    iget-object v8, v0, Lcom/baidu/android/pushservice/c/b;->a:Ljava/util/ArrayList;
    ...
    invoke-virtual {v9, v10, v0}, Lorg/json/JSONObject;->put(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    :try_end_7f
    .catch Ljava/lang/Exception; {:try_start_5f .. :try_end_7f} :catch_86
    ...
    invoke-static {v10, v0}, Lcom/baidu/android/pushservice/h/a;->e(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v7, v0, v1}, Lorg/json/JSONObject;->put(Ljava/lang/String;I)Lorg/json/JSONObject;
    :try_end_eb
    .catch Lorg/json/JSONException; {:try_start_aa .. :try_end_eb} :catch_f1
...
.method public static b(Landroid/content/Context;)Z
    ...
    :cond_4
    invoke-static {p0}, Lcom/baidu/android/pushservice/util/g;->e(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-static {p0, v0, v1}, Lcom/baidu/android/pushservice/util/g;->a(Landroid/content/Context;J)V
    ...
    invoke-static {p0, v2, v1}, Lcom/baidu/android/pushservice/util/e;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V
...
.method public static d(Landroid/content/Context;)Ljava/lang/String;
    ...
    sget v1, Lcom/baidu/android/pushservice/util/g;->a:I
