...
.method public static a(Landroid/content/Context;Ljava/lang/String;)Lcom/baidu/bdgame/sdk/obf/in;
    .registers 5
    ...
    invoke-direct {v0, p0, v1, v2}, Lcom/baidu/bdgame/sdk/obf/in;-><init>(Landroid/content/Context;Ljava/lang/String;Lcom/baidu/bdgame/sdk/obf/la;)V
    ...
    .line 40
    iput-object p1, v0, Lcom/baidu/bdgame/sdk/obf/in;->a:Ljava/lang/String;
...
.method protected a(Lcom/baidu/bdgame/sdk/obf/la;ILcom/baidu/bdgame/sdk/obf/ky;Lorg/json/JSONObject;)Z
    ...
    .line 53
    :cond_6
    new-instance v3, Lcom/baidu/bdgame/sdk/obf/io;

    invoke-direct {v3}, Lcom/baidu/bdgame/sdk/obf/io;-><init>()V
    ...
    invoke-virtual {v3, v0}, Lcom/baidu/bdgame/sdk/obf/io;->a(I)V
    :try_end_2b
    ...
    .line 86
    invoke-static {v0}, Lcom/baidu/bdgame/sdk/obf/jv;->a(Ljava/lang/String;)Lcom/baidu/bdgame/sdk/obf/jv;

    move-result-object v0

    .line 87
    invoke-virtual {v3, v0}, Lcom/baidu/bdgame/sdk/obf/io;->a(Lcom/baidu/bdgame/sdk/obf/jv;)V
    ...
    invoke-static {v6, v7}, Lcom/baidu/bdgame/sdk/obf/ly;->a(Lorg/json/JSONObject;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v6, v8}, Lcom/baidu/bdgame/sdk/obf/ly;->a(Lorg/json/JSONObject;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v6

    .line 105
    new-instance v8, Lcom/baidu/bdgame/sdk/obf/id;

    invoke-direct {v8}, Lcom/baidu/bdgame/sdk/obf/id;-><init>()V

    .line 106
    invoke-virtual {v8, v7}, Lcom/baidu/bdgame/sdk/obf/id;->a(Ljava/lang/String;)V

    .line 107
    invoke-virtual {v8, v6}, Lcom/baidu/bdgame/sdk/obf/id;->b(Ljava/lang/String;)V
    ...
    .line 113
    :cond_93
    invoke-virtual {v3, v5}, Lcom/baidu/bdgame/sdk/obf/io;->a(Ljava/util/List;)V
