...
.method public static parse(Ljava/lang/String;)Lcom/nearme/platform/opensdk/pay/PayResponse;
    ...
    iput-object v2, v0, Lcom/nearme/platform/opensdk/pay/PayResponse;->mPayChannel:Ljava/lang/String;
    ...
    :try_end_74
    .catch Ljava/lang/Exception; {:try_start_15 .. :try_end_74} :catch_75
