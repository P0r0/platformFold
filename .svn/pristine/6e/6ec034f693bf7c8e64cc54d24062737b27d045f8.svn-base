...
.method private b()V
    ...
    const-string v1, "security_pwd_free_layout"
    ...
    const-string v1, "security_contact_layout"
...
.method private c()V
    ...
    const-string v5, "protection_part_layout"
    ...
    const-string v5, "security_protection_inner_divider"
    ...
    const-string v1, "protection_part_layout"
...
.method private f()I
    ...
    invoke-interface {v1}, Ljava/util/List;->size()I
    :try_end_25
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_5 .. :try_end_25} :catch_2c
...
.method private j()V
    ...
    :try_end_37
    .catch Ljava/lang/Exception; {:try_start_2 .. :try_end_37} :catch_52
...
.method public onClick(Landroid/view/View;)V
    ...
    const-string v2, "security_pwd_free_layout"
    ...
    const-string v2, "security_contact_layout"
    ...
    const-string v1, "wallet_base_help_phone_no_dial"
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    const-string v1, "bd_wallet_activity_securitycenter"
...
.method public onPrepareDialog(ILandroid/app/Dialog;)V
    ...
    const-string v1, "bd_wallet_passfree_no_pwd_tips"
    ...
    const-string v2, "bd_wallet_passfree_no_pwd_toset"
