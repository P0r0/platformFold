.class public Lmobisocial/longdan/LDObjects$ContactDetails;
...
.field public Hashidentities:Ljava/util/List;
    .annotation runtime Lcom/google/gson/annotations/SerializedName;
        value = "h"
    .end annotation
    ...
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List",
            "<",
            "Lmobisocial/longdan/LDObjects$IdentityHash;",
            ">;"
        }
    .end annotation
.end field
...
.field public Identities:Ljava/util/List;
    ...
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List",
            "<",
            "Lmobisocial/longdan/LDObjects$Identity;",
            ">;"
        }
    .end annotation
.end field
...
.field public WasContact:Ljava/lang/Boolean;
    .annotation runtime Lcom/google/gson/annotations/SerializedName;
        value = "wc"
    .end annotation
.end field
