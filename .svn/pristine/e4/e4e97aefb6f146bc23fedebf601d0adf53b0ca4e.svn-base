...
.method public a(Lcom/baidu/android/pushservice/c/i;)V
    ...
    :try_end_3d
    .catchall {:try_start_4 .. :try_end_3d} :catchall_77
    ...
    invoke-static {v1, v3, v0}, Lcom/baidu/android/pushservice/util/e;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V
    :try_end_57
    .catch Ljava/lang/Exception; {:try_start_3e .. :try_end_57} :catch_59
    .catchall {:try_start_3e .. :try_end_57} :catchall_77
