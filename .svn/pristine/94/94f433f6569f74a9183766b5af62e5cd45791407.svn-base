...
.method public a(ILcom/duoku/platform/h/a;I)V
    ...
    new-instance v1, Lcom/duoku/platform/a/i;
    ...
    invoke-direct {v1, v2, v3}, Lcom/duoku/platform/a/i;-><init>(Landroid/content/Context;Ljava/util/ArrayList;)V

    invoke-static {v0, v1}, Lcom/duoku/platform/view/user/b;->a(Lcom/duoku/platform/view/user/b;Lcom/duoku/platform/a/i;)V
    ...
    invoke-static {v1}, Lcom/duoku/platform/view/user/b;->l(Lcom/duoku/platform/view/user/b;)Lcom/duoku/platform/a/i;
    ...
    invoke-static {v0}, Lcom/duoku/platform/view/user/b;->l(Lcom/duoku/platform/view/user/b;)Lcom/duoku/platform/a/i;

    move-result-object v0

    invoke-virtual {v0}, Lcom/duoku/platform/a/i;->notifyDataSetChanged()V
