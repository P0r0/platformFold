...
.method public toString()Ljava/lang/String;
    ...
    const-string v1, " \uff1a easypayIsEnable="
    ...
    const-string v1, " && bankCardSelectedIdx="
    ...
    const-string v1, " && balanceTransAmount="
    ...
    const-string v1, " && balancePayAmount="
    ...
    const-string v1, " && creditPayAmount="
