...
.method public static getCardDesc(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;I)Ljava/lang/String;
    ...
    const-string v0, "wallet_base_mode_credit"
    ...
    :cond_40
    const-string v0, "wallet_base_mode_debit"
...
.method decrypt()V
    ...
    const-string v2, "certificate_code:"
...
.method public toString()Ljava/lang/String;
    ...
    const-string v1, "account_no_head_tail = "
    ...
    const-string v1, "bankground_url = "
