...
.method public constructor <init>(Landroid/content/Context;Lorg/json/JSONObject;Lorg/json/JSONArray;)V
    ...
    iput v9, p0, Lcom/unionpay/mobile/android/widgets/a;->b:I
    ...
    invoke-static {p3, v1}, Lcom/unionpay/mobile/android/utils/g;->b(Lorg/json/JSONArray;I)Ljava/lang/Object;
    ...
    :cond_80
    invoke-static {}, Lcom/unionpay/mobile/android/widgets/a;->f()Ljava/util/List;
    ...
    iget-object v1, p0, Lcom/unionpay/mobile/android/widgets/a;->c:Landroid/content/Context;
    ...
    iget-object v0, p0, Lcom/unionpay/mobile/android/widgets/a;->l:Landroid/widget/RelativeLayout;
    ...
    iget-object v3, p0, Lcom/unionpay/mobile/android/widgets/a;->c:Landroid/content/Context;
    ...
    invoke-direct {v2, p0}, Lcom/unionpay/mobile/android/widgets/d;-><init>(Lcom/unionpay/mobile/android/widgets/a;)V
    ...
    iget-object v2, p0, Lcom/unionpay/mobile/android/widgets/a;->c:Landroid/content/Context;
    ...
    iget-boolean v1, p0, Lcom/unionpay/mobile/android/widgets/a;->h:Z

    if-eqz v1, :cond_1c6

    iget-object v1, p0, Lcom/unionpay/mobile/android/widgets/a;->p:Landroid/widget/TextView;

    invoke-virtual {p0}, Lcom/unionpay/mobile/android/widgets/a;->h()Ljava/lang/String;

    move-result-object v2

    invoke-static {v2}, Lcom/unionpay/mobile/android/widgets/a;->b(Ljava/lang/String;)Ljava/lang/String;
...
.method public final a()Ljava/lang/String;
    ...
    iget-boolean v2, p0, Lcom/unionpay/mobile/android/widgets/a;->h:Z
