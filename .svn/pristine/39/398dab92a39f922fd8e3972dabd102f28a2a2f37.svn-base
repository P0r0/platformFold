...
.method public run()V
    ...
    invoke-static/range {v0 .. v5}, Lcom/baidu/android/pushservice/util/q;->a(Landroid/content/Context;ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;S)V
    ...
    invoke-static {v0, v1}, Lcom/baidu/android/pushservice/h/a;->b(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_11d
    .catch Ljava/lang/Exception; {:try_start_44 .. :try_end_11d} :catch_11f
