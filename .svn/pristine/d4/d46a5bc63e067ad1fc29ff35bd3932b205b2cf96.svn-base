...
.method public constructor <init>(Landroid/os/Looper;[Ljava/lang/String;)V
    .registers 6
    .param p1, "looper"    # Landroid/os/Looper;
    .param p2, "allowedContentTypes"    # [Ljava/lang/String;
    ...
    .line 50
    iput-object p2, p0, Lcom/baidu/cloudsdk/common/http/BinaryHttpResponseHandler;->mAllowedContentTypes:[Ljava/lang/String;
