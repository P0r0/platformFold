.class public Lcom/bbkmobile/iqoo/payment/tenpay/VivoQQPayResultActivity;
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0}, Lcom/bbkmobile/iqoo/payment/tenpay/VivoQQPayResultActivity;->getApplication()Landroid/app/Application;
    ...
    invoke-virtual {p0, v0}, Lcom/bbkmobile/iqoo/payment/tenpay/VivoQQPayResultActivity;->setContentView(I)V

    sget-object v0, Lcom/bbkmobile/iqoo/payment/tenpay/TencentPay;->appId:Ljava/lang/String;
    ...
    iput-object v0, p0, Lcom/bbkmobile/iqoo/payment/tenpay/VivoQQPayResultActivity;->a:Lcom/tencent/mobileqq/openpay/api/IOpenApi;

    iget-object v0, p0, Lcom/bbkmobile/iqoo/payment/tenpay/VivoQQPayResultActivity;->a:Lcom/tencent/mobileqq/openpay/api/IOpenApi;

    if-eqz v0, :cond_25

    iget-object v0, p0, Lcom/bbkmobile/iqoo/payment/tenpay/VivoQQPayResultActivity;->a:Lcom/tencent/mobileqq/openpay/api/IOpenApi;

    invoke-virtual {p0}, Lcom/bbkmobile/iqoo/payment/tenpay/VivoQQPayResultActivity;->getIntent()Landroid/content/Intent;
    ...
    :cond_25
    invoke-virtual {p0}, Lcom/bbkmobile/iqoo/payment/tenpay/VivoQQPayResultActivity;->finish()V
...
.method protected onNewIntent(Landroid/content/Intent;)V
    ...
    invoke-virtual {p0, p1}, Lcom/bbkmobile/iqoo/payment/tenpay/VivoQQPayResultActivity;->setIntent(Landroid/content/Intent;)V
...
.method public onOpenResponse(Lcom/tencent/mobileqq/openpay/data/base/BaseResponse;)V
    ...
    sget-object v2, Lcom/bbkmobile/iqoo/payment/tenpay/TencentPay;->mTencentPayCallBack:Landroid/os/Handler;
    ...
    :cond_c3
    sget-object v1, Lcom/bbkmobile/iqoo/payment/tenpay/TencentPay;->mTencentPayCallBack:Landroid/os/Handler;

    const/4 v2, 0x1

    new-instance v3, Ljava/lang/StringBuilder;

    invoke-virtual {p0}, Lcom/bbkmobile/iqoo/payment/tenpay/VivoQQPayResultActivity;->getResources()Landroid/content/res/Resources;
    ...
    invoke-static {v1, v2, v3}, Lcom/bbkmobile/iqoo/payment/util/UtilTool;->handlerMessage(Landroid/os/Handler;ILjava/lang/String;)V
