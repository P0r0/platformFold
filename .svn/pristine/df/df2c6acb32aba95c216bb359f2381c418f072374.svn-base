...
.method private a()V
    ...
    const-string v2, "ebpay_layout_bind_card_amountinfo_view"
    ...
    const-string v1, "pay_price_text"
    ...
    const-string v1, "pay_selectpay_text"
    ...
    const-string v1, "pay_selectpay_layout"
