...
public class SDKDemoUnityCore {
     ...
     */
    public static void initSDK(final Activity context, final String jonString) {
    ...
    private static cn.uc.gamesdk.sa.iface.open.UCCallbackListener<String> sdkInitListener =  new cn.uc.gamesdk.sa.iface.open.UCCallbackListener<String>() {
        ...
        public void callback(int statuscode, String msg) {
            ...
            case UCGameSDKStatusCode.SUCCESS: {
                try {
                    UnityPlayer.UnitySendMessage("Main Camera", "onSDKInitSuccessful", msg);
                } catch (Throwable e) {
                    e.printStackTrace();
                }
            }
        ...
        UCGameSdk.defaultSdk().exit(context, new UCCallbackListener<String>(){
            ...
            public void callback(int paramInt, String paramT) {
                if (UCGameSDKStatusCode.SDK_EXIT == paramInt) {
                    ...
                    UnityPlayer.UnitySendMessage("Main Camera", "onExitSDK", paramT);
                } else {
        ...
        public void onSuccessful(int code, Response response) {
            if (null != response) {
                try {
                    ...
                    UnityPlayer.UnitySendMessage("Main Camera", "onPaySuccessful", result.toString());
                } catch (Exception e) {
                    e.printStackTrace();
    ...
    private static void notifyError(int code, String message) {
        try {
            ...
            UnityPlayer.UnitySendMessage("Main Camera", "onErrorResponse", result.toString());
        } catch (Exception e) {
