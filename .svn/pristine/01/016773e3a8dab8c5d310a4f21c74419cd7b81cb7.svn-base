...
.field public static zzazR:I

.field public static zzazS:I

.field public static zzazT:I

.field static zzazU:Lcom/google/android/gms/gcm/GoogleCloudMessaging;

.field private static final zzazX:Ljava/util/concurrent/atomic/AtomicInteger;


# instance fields
.field private context:Landroid/content/Context;

.field private zzazV:Landroid/app/PendingIntent;

.field private zzazW:Ljava/util/Map;
...
.field final zzazZ:Landroid/os/Messenger;
...
.method static constructor <clinit>()V
    ...
    sput v0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzazR:I

    const v0, 0x632ea0

    sput v0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzazS:I

    const v0, 0x6acfc0

    sput v0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzazT:I
    ...
    sput-object v0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzazX:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzazY:Ljava/util/concurrent/BlockingQueue;
    ...
    iput-object v0, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzazW:Ljava/util/Map;
    ...
    iput-object v0, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzazZ:Landroid/os/Messenger;
...
.method public static declared-synchronized getInstance(Landroid/content/Context;)Lcom/google/android/gms/gcm/GoogleCloudMessaging;
    ...
    :try_start_3
    sget-object v0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzazU:Lcom/google/android/gms/gcm/GoogleCloudMessaging;
    ...
    sput-object v0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzazU:Lcom/google/android/gms/gcm/GoogleCloudMessaging;
...
.method static synthetic zza(Lcom/google/android/gms/gcm/GoogleCloudMessaging;)Ljava/util/concurrent/BlockingQueue;
    ...
    iget-object v0, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzazY:Ljava/util/concurrent/BlockingQueue;
...
.method private zza(Ljava/lang/String;Ljava/lang/String;JILandroid/os/Bundle;)V
    ...
    invoke-static {v1}, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzaz(Landroid/content/Context;)Ljava/lang/String;
...
.method public static zzaA(Landroid/content/Context;)I
    ...
    :try_start_4
    invoke-static {p0}, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzaz(Landroid/content/Context;)Ljava/lang/String;
...
.method private zzl(Landroid/content/Intent;)Z
    ...
    iget-object v1, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzazW:Ljava/util/Map;
...
.method private zzvm()Ljava/lang/String;
    .registers 3
    ...
    sget-object v1, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzazX:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method public close()V
    ...
    sput-object v0, Lcom/google/android/gms/gcm/zza;->zzazH:Lcom/google/android/gms/gcm/zza;

    invoke-virtual {p0}, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzvn()V
...
.method public varargs declared-synchronized register([Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->context:Landroid/content/Context;

    invoke-static {v2}, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzaz(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-virtual {p0, v1}, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzy(Landroid/os/Bundle;)Landroid/content/Intent;
...
.method declared-synchronized zzm(Landroid/content/Intent;)V
    ...
    :try_start_1
    iget-object v0, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzazV:Landroid/app/PendingIntent;
    ...
    iput-object v0, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzazV:Landroid/app/PendingIntent;

    :cond_19
    const-string v0, "app"

    iget-object v1, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzazV:Landroid/app/PendingIntent;
...
.method declared-synchronized zzvn()V
    .registers 2
...
.method zzy(Landroid/os/Bundle;)Landroid/content/Intent;
    .registers 6
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-direct {p0}, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzvm()Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzazZ:Landroid/os/Messenger;
