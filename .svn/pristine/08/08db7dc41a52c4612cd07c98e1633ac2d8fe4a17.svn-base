.class Lcom/huanju/data/content/raw/info/z;
...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;III)V
    ...
    iput-object v0, p0, Lcom/huanju/data/content/raw/info/z;->a:Ljava/lang/String;

    const/16 v0, 0xa

    iput v0, p0, Lcom/huanju/data/content/raw/info/z;->b:I

    const/4 v0, 0x1

    iput v0, p0, Lcom/huanju/data/content/raw/info/z;->c:I

    const/4 v0, 0x0

    iput v0, p0, Lcom/huanju/data/content/raw/info/z;->d:I
    ...
    iput p3, p0, Lcom/huanju/data/content/raw/info/z;->b:I

    iput p4, p0, Lcom/huanju/data/content/raw/info/z;->c:I

    iput p5, p0, Lcom/huanju/data/content/raw/info/z;->d:I
...
.method public getName()Ljava/lang/String;
    ...
    const-string v0, "HjRequestInfoAlbumListTask"
...
.method protected getURL()Ljava/lang/String;
    ...
    iget-object v3, p0, Lcom/huanju/data/content/raw/info/z;->a:Ljava/lang/String;

    aput-object v3, v1, v2

    const/4 v2, 0x1

    invoke-virtual {p0}, Lcom/huanju/data/content/raw/info/z;->getAppID()Ljava/lang/String;
    ...
    iget v3, p0, Lcom/huanju/data/content/raw/info/z;->c:I
    ...
    iget v3, p0, Lcom/huanju/data/content/raw/info/z;->b:I
    ...
    iget v3, p0, Lcom/huanju/data/content/raw/info/z;->d:I
