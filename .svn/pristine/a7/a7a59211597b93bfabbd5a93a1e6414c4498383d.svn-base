...
.method public static getPhoneContracts(Landroid/content/Context;)Ljava/util/HashMap;
    ...
    invoke-virtual {v0}, Lcom/baidu/wallet/core/utils/ConsumeTimeUtils$TimeResult;->toString()Ljava/lang/String;
    :try_end_77
    .catch Ljava/lang/Exception; {:try_start_16 .. :try_end_77} :catch_6b
...
.method public static getSimContracts(Landroid/content/Context;)Ljava/util/HashMap;
    ...
    invoke-interface {v0}, Landroid/database/Cursor;->close()V
    :try_end_5f
    .catch Ljava/lang/Exception; {:try_start_13 .. :try_end_5f} :catch_5a
