...
.method private a()V
    ...
    const-string v2, "ebpay_layout_bind_card_bankinfo_view"
    ...
    const-string v1, "bindcard_bankinfo_logo"
    ...
    const-string v1, "bindcard_bankinfo_txt"
...
.method public setBankInfo(Ljava/lang/String;Ljava/lang/CharSequence;)V
    ...
    const-string v2, "wallet_base_banklogo_defult"
