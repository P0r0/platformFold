...
.method constructor <init>(Lcom/baidu/paysdk/ui/BindCardImplActivity;)V
    ...
    iput-object p1, p0, Lcom/baidu/paysdk/ui/w;->a:Lcom/baidu/paysdk/ui/BindCardImplActivity;

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    const/4 v0, 0x0

    iput-boolean v0, p0, Lcom/baidu/paysdk/ui/w;->b:Z
...
.method public afterTextChanged(Landroid/text/Editable;)V
    ...
    iget-boolean v0, p0, Lcom/baidu/paysdk/ui/w;->b:Z

    if-nez v0, :cond_16

    iget-object v0, p0, Lcom/baidu/paysdk/ui/w;->a:Lcom/baidu/paysdk/ui/BindCardImplActivity;

    const-string v1, "clickInputIdCard"

    const-string v2, ""

    iget-object v3, p0, Lcom/baidu/paysdk/ui/w;->a:Lcom/baidu/paysdk/ui/BindCardImplActivity;
    ...
    iget-object v1, p0, Lcom/baidu/paysdk/ui/w;->a:Lcom/baidu/paysdk/ui/BindCardImplActivity;
    ...
    iget-object v2, p0, Lcom/baidu/paysdk/ui/w;->a:Lcom/baidu/paysdk/ui/BindCardImplActivity;
    ...
    invoke-virtual {v2}, Lcom/baidu/paysdk/ui/widget/BankUserInfoView;->getIdTip()Landroid/widget/ImageView;
