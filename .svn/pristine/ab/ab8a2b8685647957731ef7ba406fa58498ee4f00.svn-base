...
.method public onClick(Landroid/view/View;)V
    ...
    invoke-virtual {v2, v3}, Lcom/duoku/platform/i/a;->a(Ljava/lang/String;)V
    ...
    invoke-virtual {v2, v3, v4}, Lcom/duoku/platform/i/a;->a(Landroid/content/Context;Ljava/lang/String;)V
