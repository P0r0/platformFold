...
.method public varargs a([Landroid/graphics/Bitmap;)V
    ...
    invoke-static {v0, v1}, Lcom/baidu/android/pushservice/g/l;->a(Landroid/content/Context;Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
    ...
    invoke-static {v1, v2}, Lcom/baidu/android/pushservice/g/l;->c(Landroid/content/Context;Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
