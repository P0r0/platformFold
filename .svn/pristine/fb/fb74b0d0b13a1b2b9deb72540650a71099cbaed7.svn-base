...
THREE_OPERATOR_FILES_CM_BASE = [
    ...
    "assets/edfile/x86/libmiguED.so",
    "assets/Config.xml",
    "assets/libmg20p_03.08.01_00.so",
    "assets/libmg20p_03.08.01_00.so.x86",
    "assets/mg20css.dat",
    "assets/mg20dss.dat",
    "assets/mg20dss.dat.x86",
    "assets/MiguPay.Sdk20.Lib_26002_2C0CBBCBE5256201F65BD11B4B55A21E.dat",
]

THREE_OPERATOR_FILES_UNICOM = [
  'assets/arm64-v8a/libdecrypt.jar',
  'assets/armeabi/libdecrypt.jar',
  'assets/armeabi-v7a/libdecrypt.jar',
  'assets/x86/libdecrypt.jar',
  'assets/unicom_classez.jar',
  
  'assets/unipaysdk_res/accountsdk_2_arrow_right_gray.png',
  'assets/unipaysdk_res/accountsdk_2_btn_grey.9.png',
  'assets/unipaysdk_res/accountsdk_2_btn_modify_uinfo.png',
  'assets/unipaysdk_res/accountsdk_2_checkbox_set.png',
  'assets/unipaysdk_res/accountsdk_2_checkbox_unset.png',
  'assets/unipaysdk_res/accountsdk_2_float_btn_account.png',
  'assets/unipaysdk_res/accountsdk_2_float_btn_account_pressed.png',
  'assets/unipaysdk_res/accountsdk_2_float_btn_activity.png',
  'assets/unipaysdk_res/accountsdk_2_float_btn_activity_pressed.png',
  'assets/unipaysdk_res/accountsdk_2_float_btn_point.png',
  'assets/unipaysdk_res/accountsdk_2_float_btn_point_pressed.png',
  'assets/unipaysdk_res/accountsdk_2_green_radio.png',
  'assets/unipaysdk_res/accountsdk_2_green_radio_checked.png',
  'assets/unipaysdk_res/accountsdk_2_icon_fail.png',
  'assets/unipaysdk_res/accountsdk_2_pointbar.png',
  'assets/unipaysdk_res/accountsdk_2_portrait_default.png',
  'assets/unipaysdk_res/default_banner.png',
  'assets/unipaysdk_res/dot_black.png',
  'assets/unipaysdk_res/loading1.png',
  'assets/unipaysdk_res/myhongbao.png',
  'assets/unipaysdk_res/myjifen.png',
  'assets/unipaysdk_res/mywobi.png',
  'assets/unipaysdk_res/mywoquan.png',
  'assets/unipaysdk_res/privilege_dot.png',
  'assets/unipaysdk_res/triangle_down.png',
  'assets/unipaysdk_res/triangle_up.png',
  'assets/unipaysdk_res/unicom_adv_title.png',
  'assets/unipaysdk_res/unicom_alipay.png',
  'assets/unipaysdk_res/unicom_allright.png',
  'assets/unipaysdk_res/unicom_back.png',
  'assets/unipaysdk_res/unicom_bankcard.png',
  'assets/unipaysdk_res/unicom_boxbg.png',
  'assets/unipaysdk_res/unicom_btn_back.png',
  'assets/unipaysdk_res/unicom_btn_close.png',
  'assets/unipaysdk_res/unicom_btn_refresh.png',
  'assets/unipaysdk_res/unicom_btn_usercenter.png',
  'assets/unipaysdk_res/unicom_btn_x.png',
  'assets/unipaysdk_res/unicom_chongzhicard.png',
  'assets/unipaysdk_res/unicom_circlerect_bg.png',
  'assets/unipaysdk_res/unicom_close_new_normal.png',
  'assets/unipaysdk_res/unicom_close_new_press.png',
  'assets/unipaysdk_res/unicom_gift.png',
  'assets/unipaysdk_res/unicom_gou.png',
  'assets/unipaysdk_res/unicom_hot.png',
  'assets/unipaysdk_res/unicom_hotline.png',
  'assets/unipaysdk_res/unicom_img_card.png',
  'assets/unipaysdk_res/unicom_img_card2.png',
  'assets/unipaysdk_res/unicom_inputbox.png',
  'assets/unipaysdk_res/unicom_keyboard_clear.png',
  'assets/unipaysdk_res/unicom_light_boxbg.png',
  'assets/unipaysdk_res/unicom_progress_1.png',
  'assets/unipaysdk_res/unicom_progress_2.png',
  'assets/unipaysdk_res/unicom_progress_3.png',
  'assets/unipaysdk_res/unicom_qq.png',
  'assets/unipaysdk_res/unicom_rect_green.png',
  'assets/unipaysdk_res/unicom_red_circle.png',
  'assets/unipaysdk_res/unicom_resource.dat',
  'assets/unipaysdk_res/unicom_separate_line.png',
  'assets/unipaysdk_res/unicom_tanhao.png',
  'assets/unipaysdk_res/unicom_weixin_.png',
  'assets/unipaysdk_res/unicom_wobi.png',
  'assets/unipaysdk_res/wostore_progress.png',
  'assets/unipaysdk_res/wostore_welcome.png',
]

#EGAME文件，后续有可能校验，目前不用校验
THREE_OPERATOR_FILES_CT = [
  'assets/egame/EGAME_123.zip',
  'assets/egame/EPSH_141.zip',
]
