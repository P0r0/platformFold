...
.method public run()V
    ...
    :try_end_4e
    .catch Ljava/lang/Exception; {:try_start_33 .. :try_end_4e} :catch_cf
    ...
    invoke-static {v0}, Lcom/baidu/android/pushservice/j/c;->a(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-static/range {v0 .. v6}, Lcom/baidu/android/pushservice/util/q;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;)V
    :try_end_12d
    .catch Ljava/lang/Exception; {:try_start_d8 .. :try_end_12d} :catch_b0
