...
.method public run()V
    ...
    const-string v3, "onPageStart() \u6216 onPageEnd()\u5b89\u653e\u9519\u8bef  || onPageStart() or onPageEnd() install error."
    ...
    const-string v3, "onPause,WeakReference is already been released"
    ...
    const-string v4, "pageStayTime is "
    ...
    const-string v3, "==============page time little than 20 milli"
