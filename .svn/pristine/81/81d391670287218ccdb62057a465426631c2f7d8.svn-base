...
.method private a()V
    ...
    const-string v2, "wallet_base_safekeyboard_popupwindow"
    ...
    const-string v1, "bd_wallet_safekeyboard_popwindown_anim"
...
.method public initKeyNum(Z)V
    ...
    const-string v2, "wallet_base_safekeyboard_delkey_selector"
    ...
    const-string v2, "wallet_base_safekeyboard_numkey_selector"
