.class public Lcom/baidu/bdgame/sdk/obf/iq;
...
.method public static a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Lcom/baidu/bdgame/sdk/obf/iq;
    .registers 6

    .prologue
    .line 36
    new-instance v0, Lcom/baidu/bdgame/sdk/obf/iq;
    ...
    invoke-direct {v0, p0, v1, v2}, Lcom/baidu/bdgame/sdk/obf/iq;-><init>(Landroid/content/Context;Ljava/lang/String;Lcom/baidu/bdgame/sdk/obf/la;)V

    .line 37
    const/4 v1, 0x4

    invoke-virtual {v0, v1}, Lcom/baidu/bdgame/sdk/obf/iq;->b(I)V

    .line 38
    const/16 v1, 0x130

    invoke-virtual {v0, v1}, Lcom/baidu/bdgame/sdk/obf/iq;->a(S)V

    .line 39
    const-string v1, "CashOrderSerial"

    iput-object v1, v0, Lcom/baidu/bdgame/sdk/obf/iq;->a:Ljava/lang/String;

    .line 40
    iput-object p2, v0, Lcom/baidu/bdgame/sdk/obf/iq;->b:Ljava/lang/String;

    .line 41
    iput-object p1, v0, Lcom/baidu/bdgame/sdk/obf/iq;->f:Ljava/lang/String;

    .line 42
    return-object v0
.end method

.method public static b(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Lcom/baidu/bdgame/sdk/obf/iq;
    .registers 6
...
.method protected a(Lcom/baidu/bdgame/sdk/obf/la;)Lorg/json/JSONObject;
    ...
    .line 141
    iget-object v1, p0, Lcom/baidu/bdgame/sdk/obf/iq;->a:Ljava/lang/String;

    iget-object v2, p0, Lcom/baidu/bdgame/sdk/obf/iq;->b:Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/baidu/bdgame/sdk/obf/iq;->f:Ljava/lang/String;
...
.method protected a(Lcom/baidu/bdgame/sdk/obf/la;ILcom/baidu/bdgame/sdk/obf/ky;Lorg/json/JSONObject;)Z
    ...
    invoke-virtual {p0, v0}, Lcom/baidu/bdgame/sdk/obf/iq;->d(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 76
    :cond_20
    invoke-virtual {v2, v3}, Lcom/baidu/bdgame/sdk/obf/il;->a(Ljava/lang/String;)V
    ...
    .line 82
    :cond_39
    invoke-virtual {v2, v3}, Lcom/baidu/bdgame/sdk/obf/il;->b(Ljava/lang/String;)V
    ...
    invoke-virtual {v2, v4, v5}, Lcom/baidu/bdgame/sdk/obf/il;->a(J)V
    :try_end_61
    ...
    invoke-virtual {p0, v0}, Lcom/baidu/bdgame/sdk/obf/iq;->e(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 110
    :pswitch_98
    invoke-virtual {v2, v3}, Lcom/baidu/bdgame/sdk/obf/il;->a(I)V
    :try_end_9b
    ...
    .line 126
    :cond_be
    invoke-virtual {v2, v3}, Lcom/baidu/bdgame/sdk/obf/il;->c(Ljava/lang/String;)V
    ...
    .line 130
    invoke-virtual {v2, v1}, Lcom/baidu/bdgame/sdk/obf/il;->d(Ljava/lang/String;)V
