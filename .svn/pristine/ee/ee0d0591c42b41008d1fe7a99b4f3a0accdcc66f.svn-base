.class public Lcom/baidu/paysdk/beans/u;
...
.method public generateRequestParam()Ljava/util/List;
    ...
    invoke-virtual {v2}, Lcom/baidu/paysdk/storage/PayDataCache;->getSellerUserId()Ljava/lang/String;
    ...
    const-string v4, "seller_user_id"
    ...
    invoke-virtual {v2}, Lcom/baidu/wallet/base/datamodel/PayData$EasyPay;->getBuyerUserId()Ljava/lang/String;
    ...
    invoke-virtual {v2}, Lcom/baidu/wallet/base/datamodel/PayData$EasyPay;->getAmount()Ljava/lang/String;
    ...
    invoke-virtual {v2}, Lcom/baidu/paysdk/storage/PayDataCache;->getInsideTransOrder()Ljava/lang/String;
    ...
    const-string v4, "trans_need_to_pay"
...
.method public getUrl()Ljava/lang/String;
    ...
    iget-object v1, p0, Lcom/baidu/paysdk/beans/u;->mContext:Landroid/content/Context;
