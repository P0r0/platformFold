...
.method private a([B[B)[B
    ...
    .catch Ljava/security/GeneralSecurityException; {:try_start_0 .. :try_end_5} :catch_1d
    ...
    invoke-static {v0}, Ljavax/crypto/Mac;->getInstance(Ljava/lang/String;)Ljavax/crypto/Mac;
    :try_end_1b
    .catch Ljava/security/GeneralSecurityException; {:try_start_6 .. :try_end_1b} :catch_1d
...
.method public a(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-direct {p0, v0, v1}, Lcom/baidu/scancode/a/a;->a([B[B)[B
...
.method protected a(J)V
    ...
    const-string v2, "+++++++++HotpToken movingFactor is "
