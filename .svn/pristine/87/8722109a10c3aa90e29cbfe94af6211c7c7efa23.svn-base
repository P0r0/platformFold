...
.method private a(Landroid/widget/TextView;Ljava/lang/String;)V
    ...
    const-string v1, "ebpay_transparent"
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    const-string v1, "ebpay_operation_tip1"
    ...
    const-string v2, "ebpay_operation_tip2"
    ...
    const-string v3, "ebpay_operation_tip3"
    ...
    const-string v4, "ebpay_operation_tip4"
    ...
    const-string v5, "ebpay_operation_tip5"
    ...
    const-string v6, "ebpay_operation_tip6"
