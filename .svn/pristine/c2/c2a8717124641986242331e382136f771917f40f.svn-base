...
.method private a()V
    ...
    const-string v1, "ebpay_activity_confirm_pay"
    ...
    const-string v1, "ebpay_price_num"
    ...
    const-string v1, "ebpay_good_name"
    ...
    const-string v1, "ebpay_order_account"
    ...
    const-string v1, "ebpay_pay_account"
    ...
    const-string v1, "ebpay_pay_tips"
    ...
    const-string v1, "bpay_sp_name_tip_layout"
    ...
    const-string v1, "ebpay_good_name_tip_layout"
    ...
    const-string v1, "ebpay_order_account_tips_layout"
    ...
    const-string v1, "ebpay_pay_account_tips_layout"
...
.method private b()V
    ...
    const-string v2, "ebpay_confirm_add_card_pay_tips"
    ...
    const-string v2, "ebpay_confirm_pay_tips"
...
.method public onPause()V
    ...
    const-string v0, "ConfirmPayOrderActivity"
