...
.method protected timedOut()V
    ...
    .catch Ljava/lang/AssertionError; {:try_start_0 .. :try_end_5} :catch_26
    ...
    invoke-static {}, Lokio/Okio;->access$100()Ljava/util/logging/Logger;
    ...
    # invokes: Lokio/Okio;->isAndroidGetsocknameError(Ljava/lang/AssertionError;)Z
    invoke-static {v0}, Lokio/Okio;->access$000(Ljava/lang/AssertionError;)Z
