...
.method private a(Landroid/content/Context;)V
    ...
    const-string v0, "bd_wallet_tip_img"
    ...
    const-string v0, "bd_wallet_tip_title"
    ...
    const-string v0, "bd_wallet_progress_bar"
    ...
    const-string v0, "bd_wallet_tip_time"
    ...
    const-string v1, "wallet_base_rotate_up"
    ...
    const-string v1, "wallet_base_rotate_down"
...
.method protected createLoadingView(Landroid/content/Context;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    const-string v1, "wallet_base_refresh_bar"
...
.method public getContentSize()I
    ...
    const-string v2, "bd_wallet_header_max_padding"
...
.method protected onPullToRefresh()V
    ...
    const-string v2, "bd_wallet_refresh_pull_down"
...
.method protected onReleaseToRefresh()V
    ...
    const-string v2, "bd_wallet_refresh_release"
