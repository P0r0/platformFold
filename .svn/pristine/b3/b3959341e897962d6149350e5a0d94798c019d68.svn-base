...
.method public static final a(Landroid/content/Context;)Lcom/alipay/android/phone/mrpc/core/s;
    ...
    sget-object v0, Lcom/alipay/android/phone/mrpc/core/s;->b:Lcom/alipay/android/phone/mrpc/core/s;
    ...
    :cond_7
    invoke-static {p0}, Lcom/alipay/android/phone/mrpc/core/s;->b(Landroid/content/Context;)Lcom/alipay/android/phone/mrpc/core/s;
...
.method private static final declared-synchronized b(Landroid/content/Context;)Lcom/alipay/android/phone/mrpc/core/s;
    .registers 3

    const-class v1, Lcom/alipay/android/phone/mrpc/core/s;
    ...
    invoke-direct {v0, p0}, Lcom/alipay/android/phone/mrpc/core/s;-><init>(Landroid/content/Context;)V
...
.method public final a()Lcom/alipay/android/phone/mrpc/core/i;
    ...
    iget-object v0, p0, Lcom/alipay/android/phone/mrpc/core/s;->d:Lcom/alipay/android/phone/mrpc/core/i;
...
.method public final a(Lcom/alipay/android/phone/mrpc/core/aa;)Ljava/util/concurrent/Future;
    ...
    invoke-static {v0}, Lcom/alipay/android/phone/mrpc/core/z;->a(Landroid/content/Context;)Z
    ...
    iget-object v1, p0, Lcom/alipay/android/phone/mrpc/core/s;->c:Ljava/util/concurrent/ThreadPoolExecutor;
    ...
    iget-wide v0, p0, Lcom/alipay/android/phone/mrpc/core/s;->g:J
    ...
    iget v1, p0, Lcom/alipay/android/phone/mrpc/core/s;->h:I
    ...
    iget-wide v2, p0, Lcom/alipay/android/phone/mrpc/core/s;->e:J
    ...
    iget-wide v2, p0, Lcom/alipay/android/phone/mrpc/core/s;->f:J
    ...
    iget-wide v2, p0, Lcom/alipay/android/phone/mrpc/core/s;->g:J
    ...
    invoke-direct {v0, p0, p1}, Lcom/alipay/android/phone/mrpc/core/x;-><init>(Lcom/alipay/android/phone/mrpc/core/s;Lcom/alipay/android/phone/mrpc/core/v;)V

    new-instance v1, Lcom/alipay/android/phone/mrpc/core/t;

    invoke-direct {v1, p0, v0, v0}, Lcom/alipay/android/phone/mrpc/core/t;-><init>(Lcom/alipay/android/phone/mrpc/core/s;Ljava/util/concurrent/Callable;Lcom/alipay/android/phone/mrpc/core/x;)V
    ...
    :cond_a1
    iget-wide v0, p0, Lcom/alipay/android/phone/mrpc/core/s;->e:J

    const-wide/16 v8, 0x3e8

    mul-long/2addr v0, v8

    iget-wide v8, p0, Lcom/alipay/android/phone/mrpc/core/s;->g:J
...
.method public final a(J)V
    ...
    iput-wide v0, p0, Lcom/alipay/android/phone/mrpc/core/s;->e:J
...
.method public final b(J)V
    ...
    iget-wide v0, p0, Lcom/alipay/android/phone/mrpc/core/s;->f:J

    add-long/2addr v0, p1

    iput-wide v0, p0, Lcom/alipay/android/phone/mrpc/core/s;->f:J

    iget v0, p0, Lcom/alipay/android/phone/mrpc/core/s;->h:I

    add-int/lit8 v0, v0, 0x1

    iput v0, p0, Lcom/alipay/android/phone/mrpc/core/s;->h:I
...
.method public final c(J)V
    ...
    iput-wide v0, p0, Lcom/alipay/android/phone/mrpc/core/s;->g:J
