...
# instance fields
.field final zzacE:Landroid/os/IBinder;
...
.method public constructor <init>(Landroid/os/Parcel;)V
    ...
    iput-object v0, p0, Lcom/google/android/gms/gcm/PendingCallback;->zzacE:Landroid/os/IBinder;
...
.method public getIBinder()Landroid/os/IBinder;
    ...
    iget-object v0, p0, Lcom/google/android/gms/gcm/PendingCallback;->zzacE:Landroid/os/IBinder;
