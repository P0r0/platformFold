.class Lmobisocial/omlib/client/ClientMessagingUtils$Notifications$3;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lmobisocial/omlib/client/ClientMessagingUtils$Notifications;->notifyBlobTransferBegin([B)V
.end annotation
...
.method constructor <init>(Lmobisocial/omlib/client/ClientMessagingUtils$Notifications;Ljava/util/List;)V
    ...
    .prologue
    .line 325
    iput-object p1, p0, Lmobisocial/omlib/client/ClientMessagingUtils$Notifications$3;->this$1:Lmobisocial/omlib/client/ClientMessagingUtils$Notifications;

    iput-object p2, p0, Lmobisocial/omlib/client/ClientMessagingUtils$Notifications$3;->val$interested:Ljava/util/List;
...
.method public run()V
    ...
    .prologue
    .line 329
    iget-object v2, p0, Lmobisocial/omlib/client/ClientMessagingUtils$Notifications$3;->val$interested:Ljava/util/List;
    ...
    invoke-interface {v1, v4, v5, v6, v7}, Lmobisocial/omlib/interfaces/MessageDeliveryListener;->onAttachmentTransferBegin(JII)V
