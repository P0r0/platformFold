...
.method public static declared-synchronized a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    :try_end_13
    .catchall {:try_start_8 .. :try_end_13} :catchall_c8
    ...
    :try_end_24
    .catch Ljava/io/IOException; {:try_start_16 .. :try_end_24} :catch_bd
    .catchall {:try_start_16 .. :try_end_24} :catchall_c8
    ...
    :try_end_27
    .catch Ljava/io/IOException; {:try_start_25 .. :try_end_27} :catch_149
    .catchall {:try_start_25 .. :try_end_27} :catchall_c8
    ...
    :try_end_33
    .catch Ljava/io/IOException; {:try_start_2a .. :try_end_33} :catch_c2
    .catchall {:try_start_2a .. :try_end_33} :catchall_c8
    ...
    const-string v3, "installPlugin already installed curVersion = "
    ...
    :try_end_bb
    .catchall {:try_start_37 .. :try_end_bb} :catchall_c8
    ...
    const-string v4, "installPlugin from update curVersion = "
    ...
    .line 89
    invoke-static {p0, p1, v5, v0}, Lcom/nearme/plugin/framework/a;->a(Landroid/content/Context;Ljava/lang/String;II)Z
    :try_end_fe
    .catchall {:try_start_d3 .. :try_end_fe} :catchall_c8
    ...
    invoke-static {p0, p1, v5}, Lcom/nearme/plugin/framework/PathUtils;->getPluginInstallPath(Landroid/content/Context;Ljava/lang/String;I)Ljava/lang/String;
    ...
    :try_end_10f
    .catch Ljava/io/IOException; {:try_start_103 .. :try_end_10f} :catch_142
    .catchall {:try_start_103 .. :try_end_10f} :catchall_c8
    ...
    const-string v7, "installPlugin from assert curVersion = "
    ...
    .line 94
    invoke-static {p0, v4, p1, v5, v1}, Lcom/nearme/plugin/framework/a;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;II)Z
    ...
    invoke-virtual {v0}, Ljava/io/IOException;->printStackTrace()V
    :try_end_146
    .catchall {:try_start_111 .. :try_end_146} :catchall_c8
...
.method public static b(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Class;[Ljava/lang/Object;)Ljava/lang/Object;
    .registers 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
