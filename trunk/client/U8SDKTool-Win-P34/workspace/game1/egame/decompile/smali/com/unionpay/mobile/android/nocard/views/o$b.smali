...
.method public constructor <init>(Lcom/unionpay/mobile/android/nocard/views/o;Landroid/content/Context;Lcom/unionpay/mobile/android/nocard/views/o$a;Ljava/util/List;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput v0, p0, Lcom/unionpay/mobile/android/nocard/views/o$b;->g:I
    ...
    invoke-virtual {p0, v0}, Lcom/unionpay/mobile/android/nocard/views/o$b;->setOrientation(I)V
    ...
    iget-object v1, p1, Lcom/unionpay/mobile/android/nocard/views/o;->d:Landroid/content/Context;

    iget-object v2, p0, Lcom/unionpay/mobile/android/nocard/views/o$b;->j:Ljava/util/List;

    iget-object v3, p0, Lcom/unionpay/mobile/android/nocard/views/o$b;->e:Ljava/lang/String;

    iget-object v4, p0, Lcom/unionpay/mobile/android/nocard/views/o$b;->l:Ljava/lang/String;

    const-string v5, ""

    iget v6, p0, Lcom/unionpay/mobile/android/nocard/views/o$b;->g:I
    ...
    iput-object v0, p0, Lcom/unionpay/mobile/android/nocard/views/o$b;->c:Lcom/unionpay/mobile/android/upwidget/c;

    new-instance v0, Lcom/unionpay/mobile/android/upwidget/e;

    iget-object v1, p1, Lcom/unionpay/mobile/android/nocard/views/o;->d:Landroid/content/Context;

    iget-object v2, p0, Lcom/unionpay/mobile/android/nocard/views/o$b;->c:Lcom/unionpay/mobile/android/upwidget/c;
    ...
    iput-object v0, p0, Lcom/unionpay/mobile/android/nocard/views/o$b;->d:Lcom/unionpay/mobile/android/upwidget/e;

    iget-object v0, p0, Lcom/unionpay/mobile/android/nocard/views/o$b;->d:Lcom/unionpay/mobile/android/upwidget/e;

    iget-object v1, p0, Lcom/unionpay/mobile/android/nocard/views/o$b;->i:Landroid/widget/AdapterView$OnItemClickListener;

    invoke-virtual {v0, v1}, Lcom/unionpay/mobile/android/upwidget/e;->a(Landroid/widget/AdapterView$OnItemClickListener;)V

    iget-object v0, p0, Lcom/unionpay/mobile/android/nocard/views/o$b;->d:Lcom/unionpay/mobile/android/upwidget/e;

    iget-object v1, p0, Lcom/unionpay/mobile/android/nocard/views/o$b;->h:Landroid/view/View$OnClickListener;
    ...
    iget-object v2, p0, Lcom/unionpay/mobile/android/nocard/views/o$b;->a:Lcom/unionpay/mobile/android/nocard/views/o;

    iget-object v2, v2, Lcom/unionpay/mobile/android/nocard/views/o;->d:Landroid/content/Context;
    ...
    invoke-direct {v0, p0}, Lcom/unionpay/mobile/android/nocard/views/ae;-><init>(Lcom/unionpay/mobile/android/nocard/views/o$b;)V
    ...
    invoke-virtual {p0, v1, v0}, Lcom/unionpay/mobile/android/nocard/views/o$b;->addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
    ...
    iget-object v3, p0, Lcom/unionpay/mobile/android/nocard/views/o$b;->a:Lcom/unionpay/mobile/android/nocard/views/o;

    iget-object v3, v3, Lcom/unionpay/mobile/android/nocard/views/o;->d:Landroid/content/Context;

    invoke-direct {v2, v3}, Landroid/widget/TextView;-><init>(Landroid/content/Context;)V

    iput-object v2, p0, Lcom/unionpay/mobile/android/nocard/views/o$b;->f:Landroid/widget/TextView;

    iget-object v2, p0, Lcom/unionpay/mobile/android/nocard/views/o$b;->f:Landroid/widget/TextView;
    ...
    iget-object v3, p0, Lcom/unionpay/mobile/android/nocard/views/o$b;->f:Landroid/widget/TextView;
    ...
    invoke-virtual {p0, v0}, Lcom/unionpay/mobile/android/nocard/views/o$b;->a(I)V
...
.method static synthetic a(Lcom/unionpay/mobile/android/nocard/views/o$b;Landroid/view/View;)V
    ...
    iget-object v1, p0, Lcom/unionpay/mobile/android/nocard/views/o$b;->d:Lcom/unionpay/mobile/android/upwidget/e;
...
.method static synthetic b(Lcom/unionpay/mobile/android/nocard/views/o$b;)Ljava/util/List;
    ...
    iget-object v0, p0, Lcom/unionpay/mobile/android/nocard/views/o$b;->j:Ljava/util/List;
...
.method static synthetic d(Lcom/unionpay/mobile/android/nocard/views/o$b;)I
    ...
    iget v0, p0, Lcom/unionpay/mobile/android/nocard/views/o$b;->g:I
...
.method static synthetic e(Lcom/unionpay/mobile/android/nocard/views/o$b;)Lcom/unionpay/mobile/android/nocard/views/o$a;
    ...
    iget-object v0, p0, Lcom/unionpay/mobile/android/nocard/views/o$b;->k:Lcom/unionpay/mobile/android/nocard/views/o$a;
...
.method public final a(I)V
    ...
    iget-object v1, p0, Lcom/unionpay/mobile/android/nocard/views/o$b;->f:Landroid/widget/TextView;
