...
.method public constructor <init>(Lcom/unionpay/mobile/android/nocard/views/bd;Landroid/content/Context;)V
    ...
    invoke-virtual {p0, v0}, Lcom/unionpay/mobile/android/nocard/views/bd$a;->setOrientation(I)V
...
.method private a(Lorg/json/JSONArray;)V
    ...
    iget-object v1, p0, Lcom/unionpay/mobile/android/nocard/views/bd$a;->a:Lcom/unionpay/mobile/android/nocard/views/bd;

    iget-object v1, v1, Lcom/unionpay/mobile/android/nocard/views/bd;->d:Landroid/content/Context;
    ...
    invoke-virtual {p0, v2, v0}, Lcom/unionpay/mobile/android/nocard/views/bd$a;->addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
    ...
    iget-object v6, p0, Lcom/unionpay/mobile/android/nocard/views/bd$a;->a:Lcom/unionpay/mobile/android/nocard/views/bd;

    iget-object v6, v6, Lcom/unionpay/mobile/android/nocard/views/bd;->d:Landroid/content/Context;
    ...
    invoke-static {v7, v8}, Lcom/unionpay/mobile/android/utils/f;->a(Landroid/content/Context;F)I
    ...
    iget-object v5, p0, Lcom/unionpay/mobile/android/nocard/views/bd$a;->b:Landroid/content/Context;

    new-instance v6, Landroid/widget/RelativeLayout;

    iget-object v7, p0, Lcom/unionpay/mobile/android/nocard/views/bd$a;->b:Landroid/content/Context;
    ...
    new-instance v7, Lcom/unionpay/mobile/android/nocard/views/bg;

    invoke-direct {v7, p0, v0, v4, v1}, Lcom/unionpay/mobile/android/nocard/views/bg;-><init>(Lcom/unionpay/mobile/android/nocard/views/bd$a;ILjava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v5, v7}, Lcom/unionpay/mobile/android/utils/f;->a(Landroid/content/Context;F)I
    ...
    invoke-static {v5, v1}, Lcom/unionpay/mobile/android/utils/f;->a(Landroid/content/Context;F)I

    move-result v1

    iget-object v4, p0, Lcom/unionpay/mobile/android/nocard/views/bd$a;->a:Lcom/unionpay/mobile/android/nocard/views/bd;

    iget-object v4, v4, Lcom/unionpay/mobile/android/nocard/views/bd;->c:Lcom/unionpay/mobile/android/resource/c;
...
.method public final a(Lorg/json/JSONObject;)V
    ...
    invoke-direct {p0, v0}, Lcom/unionpay/mobile/android/nocard/views/bd$a;->a(Lorg/json/JSONArray;)V
